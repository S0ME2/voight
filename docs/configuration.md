...
| Model selection | `TEXT_DETECTOR_*`, `TEXT_RECOGNIZER_*`, `DOCUMENT_LOCALIZER_BACKEND`, `DOCALIGNER_MODEL`, `MRZ_LOCALIZER_BACKEND`, `MRZSCANNER_DETECTION_CFG`, `MRZ_RECOGNIZER_*` |
...
| GPU experiments | `TEXT_RECOGNITION_ENABLE_HPI`, `TEXT_RECOGNITION_USE_TENSORRT`, `TEXT_RECOGNITION_PRECISION` |
